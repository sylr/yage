...
func TestYAML(t *testing.T) {
  ...
  gLJ+Nu91e/apOC85VBL/rDgbakSmfHPsCo486rDB0N3Ul0qtHT1m
  -----END AGE ENCRYPTED FILE-----`,
			Expected: `password: ThisIsMyReallyEncryptedPassword`,
		},
		//		{
		...
		//  -----END AGE ENCRYPTED FILE-----
		//dup: *password`,
		//			Expected: `password: &password !crypto/age ThisIsMyReallyEncryptedPassword
		//dup: *password`,
		//		},
		//		{
		...
		//  -----END AGE ENCRYPTED FILE-----
		//dup: *password`,
		//			Expected: `db_password: &password ThisIsMyReallyEncryptedPassword
		//dup: *password`,
		//		},
		//		{
	...
	for _, test := range tests {
		input := test.Input
		for i := 0; i < 2; i++ {
			t.Run(test.Description+fmt.Sprintf("[%d]", i), func(t *testing.T) {
				...
				//}
				assert.Equal(t, test.Expected, decryptOut.String())
