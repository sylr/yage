...
GO_CROSSBUILD_PLATFORMS                  += linux/mips linux/mips/softfloat linux/mips64 linux/mips64le linux/mipsle
GO_CROSSBUILD_PLATFORMS                  += linux/riscv64 linux/s390x
GO_CROSSBUILD_PLATFORMS                  += freebsd/386 freebsd/amd64 freebsd/arm freebsd/arm64 freebsd/arm/v7 freebsd/arm/v6
GO_CROSSBUILD_PLATFORMS                  += openbsd/386 openbsd/amd64 openbsd/arm openbsd/arm64 openbsd/arm/v7 openbsd/arm/v6
GO_CROSSBUILD_PLATFORMS                  += openbsd/mips64
GO_CROSSBUILD_PLATFORMS                  += netbsd/386 netbsd/amd64 netbsd/arm netbsd/arm64 netbsd/arm/v7 netbsd/arm/v6
